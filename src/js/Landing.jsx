  ...
  <div className="landing">
    ...
    <section className="landing-section container">
      ...
      <p>
        I
        {"'"}
        m a passionate creative with a deep love for creating products and the craft of telling important stories. Because I love frontend engineering, I consider myself a frontend developer first, but I
        {"'"}
        m a full-stack developer with JavaScript, React/Redux, Ruby, and Rails experience.
      </p>
      <p>
